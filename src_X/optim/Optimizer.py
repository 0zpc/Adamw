...
class CLRAdam(optim.Optimizer):
    def __init__(self, params, lr=1e-3, lr_base=1e-4, lr_max=1e-2, step_size=1350, mode='triangular2', gamma=0.99975, betas=(0.9, 0.999), eps=1e-8, weight_decay=0, grad_norm_constraint=0.95):
        defaults = dict(lr=lr, lr_base=lr_base, lr_max=lr_max, step_size=step_size, mode=mode, gamma=gamma, betas=betas, eps=eps, weight_decay=weight_decay, grad_norm_constraint=grad_norm_constraint)
